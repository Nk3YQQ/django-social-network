...
from users.views import (LoginView, LogoutView, RedirectToCurrentUserProfile, RegisterView, UserAllListView,
                         UserDeleteView, UserDetailView, UserFriendshipListView, UserReceiversListView,
                         UserRejectedListView, UserRequestsListView, UserUpdateView)
